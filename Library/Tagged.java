...
public class Tagged implements Map {
	// Logcat debugging
    static String TAG = "com.example.taggedlib";
    
    
    /**
     * Returns the public key string from a public key PEM file (assumes file is located in the /res/raw directory)
     ...
     * @param map2 a map that contains the request headers received by the client that may contain modified request headers
     ...
     * (this value will not be considerd during the comparision and thus will be removed beforehand)
    ...
    /**
     * Returns an arraylist of strings containing all entry differences between map1 and map2...used list since entries in maps cannot contain duplicate keys
     * @param map1
     * @param map2
    ...
    public <K, V> ArrayList<String> getMapDifferenceList(Map<K, V> map1, Map<K, V> map2) {
        ...
        if (map1 == null) {
            ...
            // Compare maps and store entry differences in diffHeadersList
            // An entry is a key-value pair
